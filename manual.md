...
| Claude (Anthropic) | Cloud | `claude-sonnet-4-20250514` | Si |
...
`Edit > Preferences` apre la finestra con 7 tab:
...
### About
- Versione, autore, licenza EUPL 1.2
- Elenco completo delle funzionalita'
...
- Usa **Tab** per autocompletare i comandi (es. `/his` + Tab → `/history`)
- Premi `Esc` per annullare un comando
